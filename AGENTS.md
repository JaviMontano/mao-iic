# AAD v1.0 — Assisted Agentic Development · MetodologIA Edition

> **AAD by MetodologIA** — Assisted Agentic Development with Neo-Swiss branding.
> Specification-driven AI development with cryptographic BDD verification.
> 12 skills · 8 pipeline phases · MetodologIA Design System v6.
...
```bash
/aad:sync              # Sync upstream + reapply MetodologIA brand
/aad:dashboard         # Generate branded dashboard for active feature
/aad:status            # Pipeline status + brand sync state
```

## Brand Rules

- **Navy** `#122562` — Header borders, dark mode bg, footer
- **Gold** `#FFD700` — Accents, CTAs, focus outlines, dark mode accent
- **Blue** `#137DC5` — Success, done, verified — **NUNCA verde**
- **Poppins** headings · **Trebuchet MS** body · **JetBrains Mono** code
- Swiss 8px grid · Navy-tinted shadows · Neo-Swiss aesthetic

> Brand token mapping: `references/iic-brand-mapping.md`
> Brand overlay script: `scripts/brand-overlay.sh`
> Verification: `scripts/verify-brand.sh`
